...
chats = {}
plugins = {}
helper_id = 421905452 --Put Your Helper Bot ID Here
...
function create_config( )
  ...
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {242308353, 345452553,330758154, sudo_id},
	master_id = 242308353,
    admins = {},
    disabled_channels = {},
    moderation = {data = './data/moderation.json'},
    info_text = [[》Extra Beyond V2.0
An advanced administration bot based on BDReborn

》https://github.com/BeyondTeam/BDReborn

》Admins :
》 Founder & Developer ➣ @SoLiD《
